(function() {
  ...
  function render(forceFresh) {
    ...
    slice.slice(renderedCount).forEach(function(card) {
      var info = card.card_info;
      var price = getPrice(card);
      var tier = price ? priceTier(price.value) : null;
      var div = document.createElement('div');
      div.className = 'pkw-card' + (tier ? ' pkw-card-' + tier : '');
      div.style.opacity = '0';
      ...
      if (tier === 'gold') {
        ...
        shimmer.className = 'pkw-card-shimmer';
