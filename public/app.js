(function() {
  ...
  function render(forceFresh) {
    ...
    slice.slice(renderedCount).forEach(function(card) {
      ...
      wrap.className = 'pkw-card-wrap';
      wrap.style.animationDelay = (Math.random() * -4).toFixed(2) + 's';
      wrap.style.animationDuration = (3 + Math.random() * 1.6).toFixed(2) + 's';
