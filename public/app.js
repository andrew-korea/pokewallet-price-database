(function() {
  ...
  function attachTilt(div, gloss) {
    div.addEventListener('mousemove', function(e) {
      ...
      gloss.style.background = 'radial-gradient(circle at ' + (px * 100).toFixed(1) + '% ' + (py * 100).toFixed(1) + '%, rgba(255,255,255,.65) 0%, rgba(255,255,255,.15) 35%, rgba(255,255,255,0) 60%)';
    });
